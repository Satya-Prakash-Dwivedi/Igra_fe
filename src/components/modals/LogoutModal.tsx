        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-text-dim/60 text-sm">
              Are you sure you want to log out? You will need to re-authenticate to access your
              studio dashboard.
            </p>
          </div>
          ...
          <div className="flex flex-col w-full gap-3 pt-4">
            <Button
              ...
              onClick={onConfirm}
              isLoading={isLoading}
              className="h-14 rounded-2xl font-bold text-sm bg-primary hover:bg-primary/90 border-none shadow-xl shadow-primary/10"
            >
              Confirm Logout
            </Button>
            <Button
