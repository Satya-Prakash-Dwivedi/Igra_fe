        ...
        <div className="hidden lg:block space-y-12 animate-in slide-in-from-left-8 duration-700">
          ...
          <div className="space-y-6">
            ...
            <p className="text-text-dim/60 text-base max-w-sm">
              Join our platform to get access to professional video editing, thumbnail design, and
              more.
            </p>
          </div>
          ...
          <div className="w-full max-w-md bg-bg-card/40 border border-white/5 backdrop-blur-xl rounded-2xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl font-bold text-white tracking-tight italic">
                Start <span className="text-primary not-italic">Creative</span>
              </h2>
            </div>

            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-text-dim/40 uppercase tracking-widest px-1">
                  Full Name
                </label>
                <Input
                  type="text"
              ...
              <Button
                ...
                className="h-14 rounded-2xl font-bold text-sm shadow-2xl shadow-primary/20 mt-2 w-full"
              >
                Create Account
                <ArrowRight
                  size={18}
