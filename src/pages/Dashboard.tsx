      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
        {stats.map((stat, idx) => (
          ...
          >
            ...
            <div
              className={cn(
                'mb-6 w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center border border-white/5 group-hover:bg-primary group-hover:text-white transition-all duration-300',
                stat.color
              )}
            >
              {stat.icon}
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] font-medium text-text-dim/20 uppercase tracking-wider mt-1">
                {stat.description}
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between px-2">
            ...
            <Link
              to="/orders"
              className="text-[10px] font-bold text-primary hover:underline uppercase tracking-widest flex items-center gap-2 group"
            >
              View All{' '}
              ...
              orders.map((order, i) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between md:justify-end gap-6">
                    <div
                      className={cn(
                        'px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest border transition-all duration-300',
                    ...
                    <ArrowRight
                      size={18}
                      className="text-text-muted/40 group-hover/order:text-primary group-hover/order:translate-x-1 transition-all"
                    />
                  </div>
                </div>
              ))
        ...
        <div className="space-y-8">
          ...
          <div className="bg-bg-card/20 backdrop-blur-xl border border-white/5 rounded-2xl p-8 shadow-xl space-y-6 relative overflow-hidden group/dossier">
              ...
              <div className="flex justify-between items-end">
                <div className="space-y-1">
                  ...
                  <p className="text-lg font-bold text-white">
                    Level 02{' '}
                    <span className="text-[10px] text-text-dim/20 ml-2 uppercase">Operator</span>
                  </p>
                </div>
            ...
            <Link
              to="/profile"
              className="w-full flex items-center justify-between p-4 bg-white/[0.02] rounded-xl border border-white/5 text-[10px] font-bold text-text-dim/40 hover:text-white hover:border-primary/20 uppercase tracking-widest transition-all group/opt"
            >
              Edit Profile{' '}
              <ChevronRight
                size={14}
                className="group-hover/opt:translate-x-1 transition-transform"
              />
            </Link>
          </div>
        </div>
