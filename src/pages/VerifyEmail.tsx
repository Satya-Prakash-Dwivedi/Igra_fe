        ...
        <div className="flex flex-col items-center text-center relative z-10">
          ...
          <div className="space-y-3 mb-12">
            <div className="flex items-center justify-center gap-3">
              ...
              <p className="text-[10px] font-bold text-text-dim/40 uppercase tracking-[0.4em]">
              ...
              <div className="space-y-8">
                <div className="flex flex-col items-center justify-center text-primary">
                  <div className="relative mb-6">
                    ...
                    <Loader2
                      className="animate-spin absolute inset-0 text-primary"
                      size={64}
                      strokeWidth={2}
                      style={{ animationDuration: '3s' }}
                    />
                  </div>
                  <p className="text-sm font-bold uppercase tracking-[0.2em] text-white/60 italic">
                    {message}
                  </p>
                </div>
            ...
            {status === 'success' && (
              <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="p-8 bg-emerald-500/5 border border-emerald-500/10 rounded-[2rem] text-emerald-500 backdrop-blur-xl">
                  <p className="text-sm font-bold uppercase tracking-[0.2em] italic mb-2">
                    {message}
                  </p>
                ...
                <Link to="/login">
                  <Button
                    fullWidth
                    className="h-16 rounded-2xl bg-white text-black hover:bg-emerald-500 hover:text-white border-none text-[10px] font-bold uppercase tracking-widest shadow-2xl transition-all duration-500"
                  >
                    Access portal now
                  </Button>
                </Link>
