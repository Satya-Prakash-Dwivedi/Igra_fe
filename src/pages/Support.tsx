...
import { MessageCircle, FileText, Video, BookOpen, Plus, ArrowRight } from 'lucide-react'
      ...
      <div className="flex-1 p-6 md:p-8 bg-bg-dark min-h-screen max-w-6xl mx-auto w-full">
          ...
          {cards.map((card, idx) => (
            <div
              ...
              className={cn(
                ...
                card.active
                  ? 'border-primary shadow-lg shadow-primary/5 cursor-pointer hover:shadow-primary/20 hover:scale-[1.02]'
            ...
            >
              ...
              <p className="text-text-muted text-sm leading-relaxed">{card.subtitle}</p>
            </div>
          ))}
        </div>
        ...
        <div className="flex justify-center md:justify-start">
          <Button
            ...
            className="flex items-center gap-2 px-8 py-4 font-bold rounded-xl shadow-xl shadow-primary/20 transition-all hover:scale-105 active:scale-95"
          >
            <Plus size={20} />
