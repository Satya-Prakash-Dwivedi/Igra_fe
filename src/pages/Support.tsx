      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 pt-10 relative z-10">
        <div className="space-y-2">
          ...
          <p className="text-text-dim/60 text-sm max-w-xl">
            Our team is here to help you with any issues or questions you might have regarding your
            projects or account.
          </p>
        </div>
        ...
        {cards.map((card, idx) => (
          ...
          >
              ...
              <span
                className={cn(
                  ...
                  card.active
                    ...
                    : 'text-text-dim/40 bg-white/5 border-white/5'
                )}
              >
                {card.tag}
              </span>
            ...
            <div className="relative z-10 flex-1">
              ...
              <p className="text-text-dim/40 text-xs leading-relaxed mb-6">{card.subtitle}</p>
            </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-text-dim/40 text-sm max-w-xl">
              Search our comprehensive guides for immediate answers regarding production standards,
              billing, and platform features.
            </p>
          </div>
          <div className="text-center">
            <Button
              variant="outline"
              className="h-10 px-6 rounded-lg text-[10px] border-white/10 text-text-dim/40 cursor-not-allowed"
            >
              Coming Soon
            </Button>
          </div>
