        ...
        <div className="space-y-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
            ...
            <div className="space-y-3">
              <label className="text-[11px] font-black uppercase tracking-[0.2em] text-text-dim/40 block">
                First
              </label>
              <input
                type="text"
          ...
          <div className="space-y-6 pt-4">
            ...
            <p className="text-text-dim/60 text-xs">
              Help us get a feel for your audience and style.
            </p>
            <input
              type="text"
          ...
          <div className="space-y-6 pt-4">
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              />
              <span className="text-text-dim group-hover:text-white transition-colors text-sm font-medium">
